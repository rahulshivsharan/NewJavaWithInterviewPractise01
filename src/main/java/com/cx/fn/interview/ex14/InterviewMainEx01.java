package com.cx.fn.interview.ex14;
...
/**
 * Get even and odd numbers from the list
...
public class InterviewMainEx01 {
	...
	public static void main(String[] args) {
		try {
			...
			Map<Boolean, List<Integer>> map = numList.stream().collect(Collectors.groupingBy((num) -> num%2 == 0));
